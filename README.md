  ...
  This project demonstrates an automated pipeline that converts unstructured input into structured outputs (JSON, CSV,
  and human-readable reports) using PowerShell and LLM orchestration.

  It simulates a multi-stage processing system where each step validates and transforms data, similar to how modern
