...
**Note** Legacy but it works. It is a great example prompt to use along with the Prompt_to_CA_Prompt_Orchestrator.md
...
Ready Test: Print “Okay, I am ready. Please paste a single-game PGN.”
